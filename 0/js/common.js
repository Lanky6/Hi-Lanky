...
function bottomForm(a) {
	if (a.catid.value == 1) {
		window.open("https://www.baidu.com/baidu?word=" + encodeURI(a.infos.value));
		return false
	} else if (a.catid.value == 2) {
		window.open("https://www.google.com/search?q=" + encodeURI(a.infos.value));
		return false
	} else if (a.catid.value == 3) {
		window.open("https://www.so.com/s?q=" + encodeURI(a.infos.value));
		return false
	} else if (a.catid.value == 4) {
		window.open("https://www.bing.com/search?q=" + encodeURI(a.infos.value));
		return false
	} else if (a.catid.value == 5) {
		window.open("https://www.sogou.com/web?query=" + encodeURI(a.infos.value));
		return false

	} else if (a.catid.value == 6) {
		window.open("https://search.aol.com/aol/search?q=" + encodeURI(a.infos.value));
		return false
	} else {
		window.open("https://www.baidu.com/baidu?word=" + encodeURI(a.infos.value));
		return false
